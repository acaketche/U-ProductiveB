    ...
    <div class="row justify-content-center mb-4">
        <div class="col-md-10">
            <div class="d-flex justify-content-center align-items-center flex-wrap">
                <form action="{{ route('teknik_computer.index') }}" method="GET" class="d-flex flex-grow-1 flex-wrap justify-content-center align-items-center">
                    @auth
                    <button class="btn btn-primary me-2 mb-2 mb-md-0" type="button"
                        onclick="window.location.href='{{ route('teknik_computer.create') }}';">
                    ...
                    <div class="input-group me-2 mb-2 mb-md-0 flex-grow-1" style="max-width: 300px;">
                        <input type="text" name="search" class="form-control" placeholder="Cari Tugas Akhir" value="{{ request('search') }}">
    ...
    <div class="row row-cols-1 row-cols-md-2 row-cols-lg-3 g-4">
        ...
        <div class="col">
            <div class="card h-100 article-card">
                <a href="{{ route('teknik_computer.show', $teknik_computer->tk_id) }}" class="card-img-link">
